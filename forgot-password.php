...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Creative Travel</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
<div class="privacy">
	...
	<p style="width: 350px;">
			...
			<b>Email adress</b>  <input type="email" name="email" class="form-control" id="email" placeholder="Email Adress" required="">
	</p> 

	<p style="width: 350px;">
		
			<b>Mobile Number</b>  <input type="text" name="mobile" class="form-control" id="mobile" placeholder="Phone number" required="">
	</p> 
